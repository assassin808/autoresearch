"""Sweep 11: Fine-tune audio mix ratio.

Audio ratio=0.2 gave 3.587 (from 3.717 at 0.3). Explore this finding.
The best config now: batch128K, NS10, MuonWD=0.15
"""
...
experiments = [
    # Fine-tune audio ratio around 0.2
    ("audio_ratio=0.15", None, [
        ("AUDIO_MIX_RATIO = 0.3", "AUDIO_MIX_RATIO = 0.15"),
    ]),
    ("audio_ratio=0.10", None, [
        ("AUDIO_MIX_RATIO = 0.3", "AUDIO_MIX_RATIO = 0.10"),
    ]),
    ("audio_ratio=0.25", None, [
        ("AUDIO_MIX_RATIO = 0.3", "AUDIO_MIX_RATIO = 0.25"),
    ]),

    # Combo: audio_ratio=0.2 + embed WD experiments (lower audio ratio may need diff WD)
    ("ratio0.2 + embedWD=0.1", None, [
        ("AUDIO_MIX_RATIO = 0.3", "AUDIO_MIX_RATIO = 0.2"),
    ]),
    # ^ needs train.py mod too for embed WD
    ("ratio0.2+MuonWD=0.1", [
    ...
    # Combo: audio_ratio=0.2 + embedLR tuning
    ("ratio0.2+embedLR=0.6", [
        ("EMBEDDING_LR = 0.8", "EMBEDDING_LR = 0.6"),
    ], [
        ("AUDIO_MIX_RATIO = 0.3", "AUDIO_MIX_RATIO = 0.2"),
    ]),
    ("ratio0.2+embedLR=1.0", [
        ("EMBEDDING_LR = 0.8", "EMBEDDING_LR = 1.0"),
    ], [
        ("AUDIO_MIX_RATIO = 0.3", "AUDIO_MIX_RATIO = 0.2"),
    ]),

    # Combo: audio_ratio=0.2 + warmdown
    ("ratio0.2+warmdown=0.6", [
        ("WARMDOWN_RATIO = 0.7", "WARMDOWN_RATIO = 0.6"),
    ], [
        ("AUDIO_MIX_RATIO = 0.3", "AUDIO_MIX_RATIO = 0.2"),
    ]),
    ("ratio0.2+warmdown=0.8", [
        ("WARMDOWN_RATIO = 0.7", "WARMDOWN_RATIO = 0.8"),
    ], [
        ("AUDIO_MIX_RATIO = 0.3", "AUDIO_MIX_RATIO = 0.2"),
    ]),

    # Try even lower ratios
    ("audio_ratio=0.05", None, [
        ("AUDIO_MIX_RATIO = 0.3", "AUDIO_MIX_RATIO = 0.05"),
    ]),
]
...
print(f"\nBest previous: val_loss=3.587 (audio_ratio=0.2)")
