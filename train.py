...
WEIGHT_DECAY = 0.5      # cautious weight decay for Muon — was 0.2
...
PERROW_LR = True              # H4: per-row adaptive LR for embeddings
PERROW_LR_ALPHA = 0.5          # H4: exponent for frequency-based LR scaling
